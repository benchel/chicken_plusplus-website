...
function validateCallback(callback, name = 'cb') {
    if (typeof callback !== 'function')
        throw (0, argErrors_1.invalidArgType)(name, 'of type function', callback);
    return callback;
}
const OCTAL_REG = /^[0-7]+$/;
...
function modeToNumber(mode, def, name = 'mode') {
    ...
    if (value < 0 || value > UINT32_MAX)
        throw (0, argErrors_1.outOfRange)(name, '>= 0 && <= ' + UINT32_MAX, value);
    return value + 0;
}
function genRndStr6() {
...
function flagsToNumber(flags) {
    if (typeof flags === 'number') {
        if (!Number.isInteger(flags))
            throw (0, argErrors_1.outOfRange)('flags', 'an integer', flags);
        if (flags < INT32_MIN || flags > INT32_MAX)
            throw (0, argErrors_1.outOfRange)('flags', '>= ' + INT32_MIN + ' && <= ' + INT32_MAX, flags);
        return flags;
    }
